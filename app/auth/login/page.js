// File Path: img-compressor\app\auth\login\page.js -
  ...
  return (
    <div className="my-8">
      <div className="flex flex-col items-center justify-center">
        <div className="w-1/3 rounded-lg shadow px-6 py-8 mx-auto flex flex-col gap-4">
          <div>
            ...
            <form className="space-y-4" action="#">
              <div>
                ...
                <input
                  ...
                  name="email"
                  id="email"
                  className="bg-gray-50 border border-gray-300 text-gray-900 text-sm rounded-lg focus:ring-blue-600 focus:border-blue-600 block w-full p-1.5"
